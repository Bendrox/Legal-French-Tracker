...
#Filter on Titre Article Modificateur
def filter_on_titre_art_modificat(pd_db_file, terme_filtre :str): #"/Users/oussa/Desktop/Github_perso/Legal_FR_Tracker/data_output/Legifrance_DB_TrackChange.xlsx"
    ...
    imported_DB= pd.read_excel(pd_db_file)
    return imported_DB
